...
public class GeoapifyAddressService {
    ...
    // Minimum confidence threshold to consider an address valid (0–1 scale)
    ...
    public AddressValidationResponse validate(String street, String city, String state, String zip) {
        ...
        // Build normalized address from Geoapify's standardized fields
    ...
    private static class GeoapifyResponse {
        @JsonProperty("results") public List<GeoapifyResult> results;
    }
    ...
    private static class GeoapifyResult {
        ...
        @JsonProperty("state_code")   public String stateCode;   // 2-letter abbreviation, e.g. "MD"
        @JsonProperty("postcode")     public String postcode;
        @JsonProperty("formatted")    public String formatted;
        @JsonProperty("rank")         public GeoapifyRank rank;
    }
